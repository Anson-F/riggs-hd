    ...
    <>
      ...
      <section className="story-gallery section-shell" aria-labelledby="gallery-title">
        ...
        <div className="story-gallery__grid">
          <figure className="story-gallery__wide"><img src={assetPath("/images/original/home-action-3.jpg")} alt="Students and mentors during a Pacers learning experience" /><figcaption><span>OPPORTUNITY</span>Exposure helps a possible future feel concrete.</figcaption></figure>
          <figure><img src={assetPath("/images/original/about-program.png")} alt="Coach Riggs speaking to young basketball players" /><figcaption><span>RELATIONSHIP</span>Coaching opens the door to deeper guidance.</figcaption></figure>
          <figure><img src={assetPath("/images/original/founder-graduation.jpg")} alt="A group celebrating graduation" /><figcaption><span>FUTURE</span>Education milestones belong in the same story as sport.</figcaption></figure>
        </div>
      </section>
      ...
      <section className="video-file section-shell">
        ...
        <video controls preload="metadata" poster={assetPath("/images/original/home-program-strip.webp")} aria-describedby="reel-description"><source src={assetPath("/videos/original/program-reel.mp4")} type="video/mp4" />Your browser does not support embedded video.</video>
      </section>
